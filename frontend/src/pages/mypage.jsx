          ...
          <div className="report-card">
            ...
            <div className="report-body">
              ...
              <section className="action-step-card">
                ...
                <p className="action-step-content">
      ...
      <div className="fade-in">
        ...
        <div className="payment-grid-layout">
          ...
          <div className="payment-side-content bg-white">
            ...
            <button className="payment-view-all-btn">
              전체 결제 내역 보기
            </button>
          </div>
        </div>
        ...
        <div className="notif-settings-container">
          ...
          <div className="notif-alert-box">
            ...
            <p className="notif-alert-text">
              기기 전체 알림이 꺼져있을 경우 앱 설정을 켜도 알림이 전송되지 않을 수 있습니다. 
              휴대폰의 <span className="notif-alert-highlight">설정 {' > '} 알림</span> 메뉴에서 
              마인드웰의 '알림 허용' 상태를 확인해 주세요.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="withdraw-container">
          ...
          <div className="withdraw-notice-box">
            <div className="withdraw-notice-item">
              ...
              <p className="notice-text">보유 중인 모든 상담권({ticketCount}회)과 포인트가 즉시 소멸되며 환불이 불가능합니다.</p>
            </div>
            <div className="withdraw-notice-item">
              <span className="notice-number">2</span>
              <p className="notice-text">지금까지 작성된 모든 마음 리포트와 상담 히스토리(기록지)가 영구 삭제됩니다.</p>
            </div>
            <div className="withdraw-notice-item">
        ...
        return (
          <div className="fade-in">
            ...
            <div className="account-logout-section">
              <button className="account-logout-btn">
                <LogOut size={20} />
                로그아웃
              </button>
            </div>
          ...
          <div className="fade-in">
            ...
            <section className="mobile-only-menu">
              ...
              <div className="mobile-menu-group mt-4">
                ...
                <div className="mobile-menu-item text-rose">
                  <span>로그아웃</span>
                </div>
              </div>
            </section>
  ...
  return (
    <div className="mypage-layout-root">
      ...
      <aside className="mypage-sidebar">
        <div className="sidebar-logo-section" onClick={() => handleMenuClick('dashboard')}>
        ...
        <nav className="sidebar-nav-list">
          ...
          {menuItems.map((item) => (
            <div key={item.id} onClick={() => handleMenuClick(item.id)} className={`sidebar-nav-item ${activeMenu === item.id ? 'is-active' : ''}`}>
              <item.icon size={20} />
        ...
        <div className="sidebar-footer-nav">
          ...
          <div className="sidebar-nav-item is-logout-link">
            <LogOut size={20} />
            <span>로그아웃</span>
          </div>
        </div>
        ...
        <div className="user-welcome-header">
          <div className="user-profile-summary" onClick={() => handleMenuClick('dashboard')}>
            ...
            <div className="user-info-text">
              <h2 className="user-name-title">안녕하세요, 소현님!</h2>
