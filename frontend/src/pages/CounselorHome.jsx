            ...
            <div className="counselor-container">
                ...
                <section className="banner-card">
                    <div className="banner-text">
                        <h1>
                            두부님, 오늘 상담은 <span className="point-color">총 3건</span>입니다.
                        </h1>
                ...
                <div className="stats-container">
                    <div className="stat-card">
                        <span>이번 달 상담</span> <strong>24건</strong>
                    </div>
                    <div className="stat-card">
                        <span>이번 주 예정</span> <strong>8건</strong>
                    </div>
                    <div className="stat-card">
                        <span>미답변 문의</span> <strong className="alert">3건</strong>
                    </div>
                </div>
