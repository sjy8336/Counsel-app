...
const CounselorClient = () => {
            ...
            logs: [
                {
                    ...
                    date: '2026.05.10',
                    title: '5회차 상담 일지',
                    content: '거절 연습을 통한 자아 경계 설정...',
                    details: '직장 내 대인관계 스트레스를 호소함.',
                },
                {
                    id: 102,
                    date: '2026.05.08',
                    title: '4회차 상담 일지',
                    content: '가족 간의 대화법 개선 및 감정 조절...',
                    details: '어머니와의 대화에서 발생하는 분노 조절 기제 확인.',
                },
            ],
        },
        {
            ...
            logs: [
                {
                    ...
                    date: '2026.05.12',
                    title: '1회차 초기 면접',
                    content: '전반적인 불안 증세 확인',
                    details: '내담자의 초기 래포 형성 및 목표 설정.',
                },
            ],
        },
    ...
    // header, mobileTap에서 공유할 activeTab 상태
                ...
                <main className="history-center">
                    <div className="profile-summary-card">
                        <div className="profile-info">
                            ...
                            <span
                                className={`status-tag ${currentClient.status === '진행 중' ? 'status-ing' : 'status-wait'}`}
                            >
                                {currentClient.status}
                            </span>
                            <h2>
                                {currentClient.name} 님{' '}
                                <small>
                                    {currentClient.birth} ({currentClient.gender})
                                </small>
                            </h2>
                        </div>
