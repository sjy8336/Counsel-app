...
const Schedule = () => {
    ...
    const handleApprove = async (id) => {
        ...
        try {
            ...
            setReservations((prev) => prev.map((res) => (res.id === id ? { ...res, status: 'confirmed' } : res)));
        ...
        <div className="schedule-page-root">
            <div className="schedule-container">
                ...
                <header className="schedule-header-section">
                    <h2>
                        일정 관리 <span className="counselor-badge">전문가용</span>
                    </h2>
                    <div className="summary-cards">
                        <div className="summary-item">
                            오늘 상담 <strong>3건</strong>
                        </div>
                        <div className="summary-item pending">
                            미승인 예약 <strong>{reservations.filter((r) => r.status === 'pending').length}건</strong>
                        </div>
                    </div>
                </header>
