              ...
              <div className="hero-content">
                <div>
                  ...
                  <p className="hero-desc">
                    오늘의 감정을 기록하면 AI가 소현님의 마음 상태를 분석해 가장 따뜻한 처방을 내려드려요.
                  </p>
                </div>
              ...
              <div className="report-grid">
                <div className="donut-chart-container">
                  <svg className="donut-svg">
                    <circle cx="88" cy="88" r="70" stroke="#F1F5F9" strokeWidth="24" fill="transparent" />
                    <circle cx="88" cy="88" r="70" stroke="#8BA888" strokeWidth="24" fill="transparent" 
                      strokeDasharray="440" strokeDashoffset={440 - (440 * 65) / 100} strokeLinecap="round" />
                    <circle cx="88" cy="88" r="70" stroke="#FCD34D" strokeWidth="24" fill="transparent" 
                      strokeDasharray="440" strokeDashoffset={440 - (440 * 20) / 100} transform="rotate(234, 88, 88)" strokeLinecap="round" />
                  </svg>
