...
const MIND_GUIDES = [
  {
    ...
    imgUrl: 'https://images.unsplash.com/photo-1520206159578-54c9518423e5?q=80&w=1200&auto=format&fit=crop',
...
const GuideCard = ({ guide }) => (
  <div className="mwl-guide-card">
    <div className="mwl-guide-card__img-wrap">
      ...
      />
      <div className="mwl-guide-card__category-badge">
        {guide.category}
      </div>
    </div>
    <h4 className="mwl-guide-card__title">
      {guide.title}
    </h4>
          ...
          <section className="mwl-banner">
            <div className="mwl-banner__body">
              ...
              <p className="mwl-banner__desc">
                오늘의 감정을 기록하면 AI가 {isLoggedIn && userName ? `${userName}님의` : ''}마음 상태를 분석해<br />
                가장 따뜻한 처방을 내려드려요.
              </p>
            ...
            <div className="mwl-banner__emoji-wrap">
              <div className="mwl-banner__emoji-circle">
                😊
              </div>
              <div className="mwl-banner__emoji-badge">
                ✨
              </div>
            </div>
          </section>
          ...
          <section className="mwl-guide-section">
            <div className="mwl-guide-section__header">
              <div>
                ...
                <p className="mwl-guide-section__subtitle">{isLoggedIn && userName ? `${userName}님의` : ''} 최근 상담 주제와 관련된 추천 콘텐츠입니다.</p>
              </div>
            ...
            <div className="mwl-widget-card">
              <div>
                ...
                <div className="mwl-widget-card__healing-body">
                  ...
                  <p className="mwl-widget-card__healing-desc">긴장을 풀어주는 향긋한 차 한 잔 어때요?</p>
                </div>
              </div>
            </div>
          </div>
